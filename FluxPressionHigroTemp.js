...
function drawPressureGauge(val, div) {
    ...
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ctx.fillText('hPa', centerX, centerY - radius + 130);
    ctx.font = '12px Arial';
    ctx.fillText('Valeur moyenne', centerX, centerY + 40);
   ...
   // "Valeur maximale"
   ctx.fillText('Valeur', centerX - 30, centerY + 100 - lineHeight / 2);
   ctx.fillText('maximale', centerX - 30, centerY + 100 + lineHeight / 2);

   // "Valeur minimale"
   ctx.fillText('Valeur', centerX + 30, centerY + 100 - lineHeight / 2);
   ctx.fillText('minimale', centerX + 30, centerY + 100 + lineHeight / 2);
    ...
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ctx.fillText(val.toFixed(2) + 'hPa', centerX, centerY - 180);
}
